...
internal class PurityElementTransformer(
    ...
    fun isAutogeneratedFunction(function: IrSimpleFunction): Boolean {
        ...
        return autogeneratedFunctions.contains(name) 
                ...
                || (name == "values" || name == "valueOf") && function.parentEnumClassOrNull != null // Enum values function
                || componentRegex.matches(name) && function.parentClassOrNull?.isData == true // componentN functions for data classes
    }
